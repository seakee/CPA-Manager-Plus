...
const captureAuthSnapshot = (state: AuthStoreState) => ({
  ...
  supportsCodexClientModelOverride: state.supportsCodexClientModelOverride,
  supportsCodexClientModelInherit: state.supportsCodexClientModelInherit,
...
export function DemoPage() {
  useLayoutEffect(() => {
    ...
    useAuthStore.setState({
      ...
      supportsPlugin: true,
      supportsCodexClientModelOverride: true,
      supportsCodexClientModelInherit: true,
